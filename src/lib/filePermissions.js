...
export function octalToTriplets(octal) {
...
export function tripletsToOctal(special, owner, group, other) {
    const base = `${owner}${group}${other}`;
    return special > 0 ? `${special}${base}` : base;
}
export function bitsToRwx(bits) {
    return {
        r: (bits & 4) !== 0,
        w: (bits & 2) !== 0,
        x: (bits & 1) !== 0,
...
//# sourceMappingURL=filePermissions.js.map