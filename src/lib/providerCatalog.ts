...
export const PROVIDER_CATALOG: CatalogProvider[] = [
  ...
  { id: "command-code", name: "Command Code", kind: "openai", flavor: "openai", baseUrl: "https://api.commandcode.ai/provider/v1", defaultModel: "deepseek/deepseek-v4-flash", models: ["deepseek/deepseek-v4-flash", "anthropic/claude-sonnet-5", "openai/gpt-5.6"], needsKey: true, group: "C" },
