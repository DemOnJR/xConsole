...
export function PlainFileIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("path", { d: "M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z" }), _jsx("path", { d: "M14 3v5h5" })] }));
}
/**
...
export function labelled(tag) {
    ...
    function LabelledFileIcon({ size = 16, ...props }) {
        return (_jsxs("svg", { ...base({ size, ...props }), children: [_jsx("path", { d: "M13 3H6a1.8 1.8 0 0 0-1.8 1.8v14.4A1.8 1.8 0 0 0 6 21h12a1.8 1.8 0 0 0 1.8-1.8V9.8z" }), _jsx("path", { d: "M13 3v6.8h6.8" }), _jsx("rect", { x: "2.2", y: "12.4", width: "19.6", height: "7.6", rx: "1.6", fill: "currentColor", stroke: "none" }), _jsx("text", { x: "12", y: "18.05", textAnchor: "middle", fontSize: fontSize, fontWeight: "700", letterSpacing: "-0.2", fontFamily: "ui-sans-serif, system-ui, -apple-system, sans-serif", fill: "var(--bg, #16161e)", stroke: "none", children: tag })] }));
    }
    return LabelledFileIcon;
}
/** Source code: angle brackets. */
export function CodeFileIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("path", { d: "M9 8 5 12l4 4" }), _jsx("path", { d: "m15 8 4 4-4 4" })] }));
}
/** Markup — HTML and template languages: a tag. */
export function MarkupIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("path", { d: "M4 12 8 8v8z" }), _jsx("path", { d: "M11 18 14 6" }), _jsx("path", { d: "M20 12 16 8v8z" })] }));
}
/** Stylesheets: a droplet, for the paint. */
export function StyleIcon(props) {
    return (_jsx("svg", { ...base(props), children: _jsx("path", { d: "M12 3s6 6.6 6 10.5a6 6 0 0 1-12 0C6 9.6 12 3 12 3z" }) }));
}
/** Structured data — JSON, YAML, TOML: braces. */
export function DataIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("path", { d: "M9 4H8a2 2 0 0 0-2 2v3a2 2 0 0 1-2 2 2 2 0 0 1 2 2v3a2 2 0 0 0 2 2h1" }), _jsx("path", { d: "M15 4h1a2 2 0 0 1 2 2v3a2 2 0 0 0 2 2 2 2 0 0 0-2 2v3a2 2 0 0 1-2 2h-1" })] }));
}
/** Settings files: sliders. */
export function ConfigIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("line", { x1: "4", y1: "8", x2: "20", y2: "8" }), _jsx("line", { x1: "4", y1: "16", x2: "20", y2: "16" }), _jsx("circle", { cx: "9", cy: "8", r: "2" }), _jsx("circle", { cx: "15", cy: "16", r: "2" })] }));
}
/** Archives: a box with a band across the lid. */
export function ArchiveIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("rect", { x: "3", y: "4", width: "18", height: "5", rx: "1" }), _jsx("path", { d: "M5 9v9a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V9" }), _jsx("line", { x1: "10", y1: "13", x2: "14", y2: "13" })] }));
}
/** Images: the classic frame with a horizon and a sun. */
export function ImageFileIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("rect", { x: "3", y: "4", width: "18", height: "16", rx: "2" }), _jsx("circle", { cx: "8.5", cy: "9.5", r: "1.5" }), _jsx("path", { d: "m21 16-5-5-5 5-3-3-5 5" })] }));
}
/** Audio: a note. */
export function AudioIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("path", { d: "M9 18V6l10-2v12" }), _jsx("circle", { cx: "6.5", cy: "18", r: "2.5" }), _jsx("circle", { cx: "16.5", cy: "16", r: "2.5" })] }));
}
/** Video: a film strip. */
export function VideoIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("rect", { x: "3", y: "5", width: "18", height: "14", rx: "2" }), _jsx("line", { x1: "7", y1: "5", x2: "7", y2: "19" }), _jsx("line", { x1: "17", y1: "5", x2: "17", y2: "19" }), _jsx("line", { x1: "3", y1: "12", x2: "21", y2: "12" })] }));
}
/** Documents that are meant to be read: a sheet with lines of text. */
export function DocIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("path", { d: "M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z" }), _jsx("path", { d: "M14 3v5h5" }), _jsx("line", { x1: "8.5", y1: "13", x2: "15.5", y2: "13" }), _jsx("line", { x1: "8.5", y1: "16.5", x2: "13.5", y2: "16.5" })] }));
}
/** Spreadsheets and delimited data: a grid. */
export function SheetIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("rect", { x: "3", y: "4", width: "18", height: "16", rx: "2" }), _jsx("line", { x1: "3", y1: "10", x2: "21", y2: "10" }), _jsx("line", { x1: "3", y1: "15", x2: "21", y2: "15" }), _jsx("line", { x1: "10", y1: "10", x2: "10", y2: "20" })] }));
}
/** Slide decks: a screen on a stand. */
export function SlidesIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("rect", { x: "3", y: "4", width: "18", height: "11", rx: "1.5" }), _jsx("path", { d: "M12 15v3" }), _jsx("path", { d: "M8.5 21 12 18l3.5 3" })] }));
}
/** Databases and dumps: the cylinder. */
export function DatabaseFileIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("ellipse", { cx: "12", cy: "6", rx: "8", ry: "3" }), _jsx("path", { d: "M4 6v12c0 1.7 3.6 3 8 3s8-1.3 8-3V6" }), _jsx("path", { d: "M4 12c0 1.7 3.6 3 8 3s8-1.3 8-3" })] }));
}
/** Keys, certificates, anything secret. */
export function KeyFileIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("circle", { cx: "7.5", cy: "15.5", r: "3.5" }), _jsx("path", { d: "m10 13 8-8" }), _jsx("path", { d: "m15 8 2 2" }), _jsx("path", { d: "m18 5 2 2" })] }));
}
/** Logs: ruled lines, ragged like output. */
export function LogIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("line", { x1: "4", y1: "7", x2: "20", y2: "7" }), _jsx("line", { x1: "4", y1: "11", x2: "16", y2: "11" }), _jsx("line", { x1: "4", y1: "15", x2: "19", y2: "15" }), _jsx("line", { x1: "4", y1: "19", x2: "12", y2: "19" })] }));
}
/** Shell scripts: a prompt. */
export function ShellIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("rect", { x: "3", y: "4", width: "18", height: "16", rx: "2" }), _jsx("path", { d: "m7 9 3 3-3 3" }), _jsx("line", { x1: "12.5", y1: "15", x2: "17", y2: "15" })] }));
}
/** Compiled things: a chip. */
export function BinaryIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("rect", { x: "7", y: "7", width: "10", height: "10", rx: "1.5" }), _jsx("path", { d: "M10 3v4M14 3v4M10 17v4M14 17v4M3 10h4M3 14h4M17 10h4M17 14h4" })] }));
}
/** Fonts. */
export function FontIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("path", { d: "m5 19 6-14 6 14" }), _jsx("line", { x1: "7.5", y1: "14", x2: "14.5", y2: "14" })] }));
}
/** Disc and filesystem images. */
export function DiskIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("circle", { cx: "12", cy: "12", r: "9" }), _jsx("circle", { cx: "12", cy: "12", r: "2.5" })] }));
}
/** Symbolic links: a chain. */
export function SymlinkIcon(props) {
    return (_jsxs("svg", { ...base(props), children: [_jsx("path", { d: "M10 13a5 5 0 0 0 7.5.5l3-3a5 5 0 0 0-7-7l-1.7 1.7" }), _jsx("path", { d: "M14 11a5 5 0 0 0-7.5-.5l-3 3a5 5 0 0 0 7 7l1.7-1.7" })] }));
}
 ...
 */
const LETTERED_FAMILIES = new Set([
    CodeFileIcon,
    MarkupIcon,
    StyleIcon,
    DataIcon,
...
const BY_EXTENSION = Object.fromEntries(Object.entries(RAW_BY_EXTENSION).map(([ext, kind]) => [
    ext,
