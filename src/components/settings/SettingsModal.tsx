...
export function SettingsModal() {
  ...
  return (
    ...
    >
      <div className="flex h-[80vh] w-[min(960px,92vw)] overflow-hidden rounded-xl border border-[#1f2737] bg-[#0d121b] shadow-2xl">
        {/* Category sidebar */}
        <nav className="flex w-52 shrink-0 flex-col border-r border-[#1f2737] bg-[#0b0f17] py-3">
                ...
                <button
                  ...
                  className={`mb-0.5 flex w-full items-center gap-2.5 rounded-md px-2.5 py-2 text-left text-sm transition ${
                    isActive
                      ...
                      : "text-gray-400 hover:bg-[#11161f] hover:text-gray-200"
                  }`}
                >
                  <Icon size={16} />
                  {c.label}
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <div className="flex items-center justify-between border-b border-[#1f2737] px-5 py-3">
